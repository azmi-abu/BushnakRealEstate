      ...
      <Reveal>
        <div className="rounded-3xl border border-white/10 bg-gradient-to-l from-brandPanel to-white/5 p-8 shadow-2xl">
          ...
          <h2 className="flex items-center gap-3 text-3xl font-extrabold">
            <LightBulbIcon className="h-8 w-8 text-brandYellow drop-shadow-[0_0_12px_rgba(217,255,74,0.6)]" />
            טיפים למשקיע
          </h2>
          ...
          <div className="mt-7 grid gap-4 md:grid-cols-2">
            ...
            <Tip
              ...
              text="אזורים מתפתחים עשויים להיות אטרקטיביים, אך השקעה חכמה משלבת גם אזורים עם ביקוש יציב להשכרה ולמכירה.
בדובאי, נתוני תפוסה, נגישות, תשתיות ותכניות פיתוח קיימות הם גורמים קריטיים בקבלת ההחלטה."
            />
            <Tip
